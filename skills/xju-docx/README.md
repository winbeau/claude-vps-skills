...
规范条款速查在 [`references/spec-digest.md`](references/spec-digest.md)（页面/页码/标题/图表公式/GB.T 7714 引用/文字细则）。
...
```bash
cp -r claude-vps-skills/skills/xju-docx ~/.claude/skills/
```
